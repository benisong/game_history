...
public interface ILandOwnershipDomainService
{
    DonghanEngine.Core.Economy.LandRepurchaseResult ExecuteRepurchaseLand(string provinceId, int purchaseAmount);
